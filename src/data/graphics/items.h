...
const u32 gItemIcon_LinkCable[] = INCBIN_U32("graphics/items/icons/question_mark.4bpp.lz");
const u32 gItemIconPalette_LinkCable[] = INCBIN_U32("graphics/items/icon_palettes/question_mark.gbapal.lz");
