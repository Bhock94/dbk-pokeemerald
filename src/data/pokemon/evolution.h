const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_KADABRA]    = {{EVO_ITEM, ITEM_LINK_CABLE, SPECIES_ALAKAZAM}},
    [SPECIES_MACHOP]     = {{EVO_LEVEL, 28, SPECIES_MACHOKE}},
    [SPECIES_MACHOKE]    = {{EVO_ITEM, ITEM_LINK_CABLE, SPECIES_MACHAMP}},
    ...
    [SPECIES_GRAVELER]   = {{EVO_ITEM, ITEM_LINK_CABLE, SPECIES_GOLEM}},
    ...
    [SPECIES_HAUNTER]    = {{EVO_ITEM, ITEM_LINK_CABLE, SPECIES_GENGAR}},
